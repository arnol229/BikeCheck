...
class NoRecognitionComponent(GZFrameComponent):
    ...
    def render(self, state):
        return [
            ...
            GZFrameText(element_name="header_text", props={"text":"Can't Recognize You!", "size":40, "font":"Times New Roman", "color":"lightblue"}),
        ]